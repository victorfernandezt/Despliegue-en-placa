...
bool Vehicle::EDROOMIsComponentFinished()
{
	...
	return ( PathPlanner.EDROOMIsComponentFinished() && PathTracker.EDROOMIsComponentFinished() && AvoidObstaclesIRQ.EDROOMIsComponentFinished() && CEDROOMComponent::EDROOMIsComponentFinished());
